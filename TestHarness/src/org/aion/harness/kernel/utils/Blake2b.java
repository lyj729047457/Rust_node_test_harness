...
import static org.aion.harness.kernel.utils.Blake2b.Engine.Assert.assertFail;
import static org.aion.harness.kernel.utils.Blake2b.Engine.Assert.exclusiveLowerBound;
import static org.aion.harness.kernel.utils.Blake2b.Engine.Assert.inclusiveLowerBound;
import static org.aion.harness.kernel.utils.Blake2b.Engine.Assert.inclusiveUpperBound;
import static org.aion.harness.kernel.utils.Blake2b.Engine.LittleEndian.readInt;
import static org.aion.harness.kernel.utils.Blake2b.Engine.LittleEndian.readLong;
import static org.aion.harness.kernel.utils.Blake2b.Engine.LittleEndian.writeInt;
import static org.aion.harness.kernel.utils.Blake2b.Engine.LittleEndian.writeLong;
...
public interface Blake2b {
    ...
    class Engine implements Blake2b {
        ...
        public static final class Assert {
            ...
            static <T extends Number> String assertFail(
    ...
    class Param implements AlgorithmParameterSpec {
        ...
        public final Param setDigestLength(int len) {
            ...
            assert len <= Spec.MAX_DIGEST
                    : assertFail("len", len, inclusiveUpperBound, Spec.MAX_DIGEST);
        ...
        public final Param setKey(final byte[] key) {
            ...
            assert key.length <= Spec.MAX_KEY
                    : assertFail("key.length", key.length, inclusiveUpperBound, Spec.MAX_KEY);
        ...
        public final Param setLeafLength(int leaf_length) {
            assert leaf_length >= 0
                    : assertFail("leaf_length", leaf_length, inclusiveLowerBound, 0);
        ...
        public final Param setNodeOffset(long node_offset) {
            assert node_offset >= 0
                    : assertFail("node_offset", node_offset, inclusiveLowerBound, 0);
        ...
        public final Param setInnerLength(int inner_length) {
            assert inner_length >= 0
                    : assertFail("inner_length", inner_length, inclusiveLowerBound, 0);
        ...
        public final Param setSalt(final byte[] salt) {
            ...
            assert salt.length <= Spec.MAX_SALT
                    : assertFail("salt.length", salt.length, inclusiveUpperBound, Spec.MAX_SALT);
