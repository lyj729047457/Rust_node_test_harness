package org.aion.harness.tests.integ.rust;
...
public class AvmTxSmokeTest {
    ...
    private static final String BUILT_KERNEL = System.getProperty("user.dir") + "/aionr";
    ...
    private static final SimpleLog log = new SimpleLog(AvmTxSmokeTest.class.getName());
    ...
    public static void setup() throws Exception {
        ...
        node = NodeFactory.getNewLocalNodeInstance(NodeType.RUST_NODE);
    ...
    private TransactionReceipt sendTransaction(RawTransaction transaction) throws InterruptedException {
        IEvent transactionIsSealed = new Event(
